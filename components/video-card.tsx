  ...
  return (
    ...
    >
      ...
      <div className={cn('flex flex-col gap-2', horizontal ? 'mt-0' : 'mt-4')}>
        <span className="text-xs uppercase tracking-[0.2em] text-muted-foreground">{video.date}</span>
        ...
        <p className="text-sm leading-relaxed text-muted-foreground text-pretty md:text-base">{video.description}</p>
      </div>
    </a>
  )
}
