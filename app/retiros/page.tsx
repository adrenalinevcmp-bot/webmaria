...
export default async function RetirosPage() {
  const cfg = await getCms('agenda.page', {title:'Encuentros para el despertar', intro:'Espacios presenciales y mensuales para compartir desde el Ser, contemplar y abrirnos juntos al amor.'})
